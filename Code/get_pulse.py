...
class getPulseApp(object):
    ...
    def __init__(self, args):
        ...
        for i in range(3):  # Adjust the range as necessary
    ...
    def write_csv(self):
        ...
        """
        latest_fn = "pulselatest" + str(datetime.datetime.now())
        latest_fn = latest_fn.replace(":", "_").replace(".", "_")
        new_data = np.vstack((self.processor.t, self.processor.latest_data)).T
        np.savetxt(latest_fn + ".csv", new_data, delimiter=',')
    ...
    def toggle_search(self):
        ...
        Locking the forehead location in place significantly improves data quality.
        """
    ...
    def make_bpm_plot(self):
        ...
        """
        plotXY([[self.processor.times, self.processor.samples],
    ...
    def main_loop(self):
        ...
        imshow("Heart Rate Measurement", output_frame)
